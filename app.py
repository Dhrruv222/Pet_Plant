...
# Import custom modules - LOCAL ONLY (no Firebase)
...
sensor_data_mgr = get_sensor_data(simulate=False)  # Set to True for random simulation
...
def get_sensors():
    ...
    try:
        # Get sensor data from local file
